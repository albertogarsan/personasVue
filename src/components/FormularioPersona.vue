...
export default {
  ...
  methods: {
    enviarFormulario() {
      //this es referix al component en el qual ens trobem
      // .$emit és un mètode preestablert de vue que reb dos params.
      // Param1 -> nom de l'event
      // Param2 -> valor que volem passar en este event
